  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center px-4">
      <motion.div
        ...
        className="flex items-center space-x-2 py-1.5 px-4 sm:px-6 bg-gray-900/20 backdrop-blur-md rounded-full border border-purple-900/50 hover:border-purple-600/50 transition-colors duration-300 overflow-x-auto max-w-full shadow-lg hover:shadow-purple-500/20"
      >
      ...
      <motion.div
        ...
        className="text-xl sm:text-2xl md:text-4xl font-bold mt-4 sm:mt-6 mb-2 sm:mb-3 text-center bg-gradient-to-r from-[#b49bff] to-cyan-400 bg-clip-text text-transparent px-2"
      >
