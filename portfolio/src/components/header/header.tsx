            ...
            >
              <div className="relative w-8 h-8 sm:w-10 sm:h-10">
                ...
                <div className="relative w-full h-full bg-black rounded-xl p-2 border border-white/10 flex items-center justify-center">
                  <RiTerminalBoxFill className="w-full h-full text-white transition-colors duration-700" />
                </div>
              </div>
              <div className="flex flex-col justify-center">
                ...
                <span className="text-[10px] sm:text-xs text-gray-400">Data Scientist</span>
              </div>
            </motion.a>
              ...
              <div className="flex items-center gap-2 p-1.5 rounded-full border border-white/10 bg-black/20 backdrop-blur-sm">
                {navItems.map((item) => (
                  <a
                    key={item.id}
                    href={`#${item.id}`}
                    className={`relative flex flex-col items-center justify-center px-4 py-2 rounded-full text-sm transition-all duration-300 ${isActive === item.id
